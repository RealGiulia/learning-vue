<template>
    ...
    <div class="apresentacao">
      <img src="../assets/imagens/imagens-main/images/logo.svg" alt="Cookin'Up logo" class="logo">
    ...
    <img src="../assets/imagens/imagens-main/images/foto-banner.png" alt="" class="foto-banner">
  </header>
</template>
